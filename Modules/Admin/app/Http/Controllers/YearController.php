...
use Modules\Admin\Http\Requests\YearPostRequest;
use Yajra\DataTables\Facades\DataTables;

class YearController extends Controller
{
    protected $modelClass = 'App\Models\Year';
    protected $viewPath = 'year';
    ...
    /* ============ UPDATE FUNCTION  ============= */
    public function update(YearPostRequest $request, $id)
    {
        DB::beginTransaction();
        try {
