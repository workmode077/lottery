...
use Modules\Admin\Http\Requests\ModelYearInteriorPostRequest;
...
class ModelYearInteriorController extends Controller
{
    ...
    /* ============ STORE FUNCTION  ============= */
    public function store(ModelYearInteriorPostRequest $request, $model_year)
    {
        DB::beginTransaction();
        try {
            $input = $request->all();
    ...
    /* ============ UPDATE FUNCTION  ============= */
    public function update(ModelYearInteriorPostRequest $request, $model_year, $id)
    {
        DB::beginTransaction();
        try {
