...
class ModelYearFooterController extends Controller
{
    ...
    public function index($id)
    {
        try {
            ...
            return view('admin::vehicle.' . $this->viewPath . '.footer/create', compact(
                'data',
                'baseRouteName',
                'vehicle'
            ));
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $update->uploadMedia($request, 'footer_web_banner');
            $update->uploadMedia($request, 'footer_mobile_banner');
            $update->uploadMedia($request, 'download_spec');
            DB::commit();
