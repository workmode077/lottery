                        ...
                        <div class="row">
                             ...
                             <div class="col-md-4">
                                <div class="form-group mb-3">
                                    <label for="time" class="form-label">Super Agent*</label>
                                    <select class="form-control" name="parent_id" id="parent_id" required>
                                        @foreach($parentAgent as $agent)
                                        <option value="{{ $agent->id }}" {{ (isset($data) && $data->parent_id == $agent->id) ? 'selected' : '' }}>{{ $agent->username }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username"
                                            value="{{ isset($data) ? str_replace('AG-', '', $data->username) : '' }}"
                             ...
                             <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="plain_password" name="plain_password"
                                        value="{{ isset($data) ? $data->plain_password : '' }}"
                                        required>
                                    <span class="error-block"></span>
                                </div>
                            </div>
